...
Папка с обученной моделью расположена по следующей ссылке на Яндекс.Диск в архиве https://disk.yandex.ru/d/_o2ziDTsytae_A
Использована загрузка на Диск, так как загрузить на GitHub была затруднена из-за большого объема файлов
