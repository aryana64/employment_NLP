...
В файле output.xlsx расположена таблица с тремя полями (Условия, Требования к соискателю и Навыки), заполненными разработанной нами моделью  
В таблице Датасет (1).xlsx находятся размеченные участниками команды файлы  
